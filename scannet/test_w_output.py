...
parser.add_argument('--log_dir', default='pointcloud_log_rotated2', help='Log dir [default: log]') #The directory to output results to.
parser.add_argument('--num_point', type=int, default=4000, help='Point Number [default: 8192]')
...
parser.add_argument('--checkpoint_dir',  default='pointcloud_log2', help='Checkpoint directory') #The directory to load the model from
...
def train():
    with tf.Graph().as_default():
        ...
        #Test by running both eval functions on the test data using the model created from training.

        #The following section is commented out because we're not training here.
